...
A modern and beginner-friendly **Password Manager GUI App** built using **Python Tkinter**.
This project allows users to securely store, search, generate, view, and delete passwords with a clean dark-themed interface.
